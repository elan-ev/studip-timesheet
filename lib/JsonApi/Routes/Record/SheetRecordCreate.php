<?php
/**
 * Sheet Record Create Route Handler
 *
...
class SheetRecordCreate extends JsonApiController
{
    use ValidationTrait;
    ...
    public function __invoke(Request $request, Response $response, $args)
    {
        ...
        $record = $this->createRecord($json, $sheet);
     ...
     * @return Record
     */
    private function createRecord(array $json, Sheet $sheet)
    {
