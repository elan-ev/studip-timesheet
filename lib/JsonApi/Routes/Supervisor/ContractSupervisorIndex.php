<?php
/**
 * Contract Supervisors Index Route Handler
 *
...
class ContractSupervisorIndex extends JsonApiController
{
    /**
     * @inheritDoc
     */
    ...
    public function __invoke(Request $request, Response $response, $args)
    {
        ...
        $total = $contract->supervisors->count();
        $data = $contract->supervisors->limit($offset, $limit);
