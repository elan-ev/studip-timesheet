...
class ContractSheetCreate extends JsonApiController
{
    use ValidationTrait;
    ...
    public function __invoke(Request $request, Response $response, $args)
    {
        ...
        if (!Authority::canCreateSheet($user, $contract)) {
            throw new AuthorizationFailedException();
        }

        $sheet = $this->createSheet($json, $contract);
    ...
    /**
     * Extract data and creates sheet.
     * @param array $json
     * @return Sheet
     */
    private function createSheet(array $json, Contract $contract)
    {
