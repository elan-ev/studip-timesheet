<?php
/**
 * Workflow Log Create Route Handler
 *
...
class Create extends JsonApiController
{
    ...
    public function __invoke(Request $request, Response $response, $args)
    {
        ...
        if (!Authority::canCreateWorkflowLog($user)) {
            throw new AuthorizationFailedException();
        }

        $workflowLog = $this->createWorkflowLog($json);
     ...
     * @return WorkflowLog
     */
    private function createWorkflowLog(array $json)
    {
